...
public class FileTypeMapper {
    ...
    private void registerDocumentExtensions() {
        registerExtensions(FileCategory.DOCUMENT,
            "djvu", "doc", "docm", "docx", "dot", "dotm", "dotx", "rtf", "wpt", "wps",
            "htm", "html", "md", "hwp", "hwpx", "mht", "mhtml", "odt", "ott", "oxps",
            "pages", "pdf", "stw", "sxw", "txt", "wps", "xml", "xps", "markdown", "js", "jsx", "ts", "tsx", "mjs", "cjs", "coffee",
                "litcoffee", "css", "scss", "sass", "less", "py", "pyw", "pyt", "pyx", "pyo", "rpy", "epub",
                ...
                "tk", "gvy", "gsh", "grvy", "vhd", "vhdl", "tex", "ltx", "bib", "cls", "sty", "ins", "dtx",
                "xsd", "xsl", "xslt", "svg", "Dockerfile", "ejs", "jade", "pug", "vbhtml","gitignore","cmd","log",
                "vue", "json5", "mdx", "tf", "tfvars", "conf", "nginx", "http", "rest", "graphql", "gql", "cmake", "asm", "s", "schema", "hcl", "svelte");
    }
    ...
    private void registerSpreadsheetExtensions() {
        registerExtensions(FileCategory.SPREADSHEET,
            ...
            "xls", "xlsb", "xlsm", "xlsx", "xlt", "xltm", "xltx", "xla", "xlam");
    }
    ...
    private void registerAudioVideoExtensions() {
        registerExtensions(FileCategory.AV,
            ...
            "m4a", "aac", "ac3", "au", "flac", "ogg", "aif",
            "aifc", "aiff", "wma", "m4v", "webm", "mpg", "mpeg", "m2v", "m4p", "mj2", "ogv",
            "qt", "vob");
    }
    ...
    private void register3DExtensions() {
        registerExtensions(FileCategory.THREE_D,
            "gltf", "glb", "obj", "stl", "fbx", "ply", "dae", "wrl",
                "3ds", "3mf","3dm");
    }
    ...
    private void registerFormatCapabilities() {
        ...
        registerFormatCapability(FileCategory.SPREADSHEET,
            Arrays.asList("csv", "et", "ett", "fods", "numbers", "ods", "ots", "sxc",
                         "xls", "xlsb", "xlsm", "xlsx", "xlt", "xltm", "xltx", "xla", "xlam", "xml"),
        ...
        registerFormatCapability(FileCategory.VISIO,
            Arrays.asList("vsd", "vsdm", "vsdx", "vssm", "vssx", "vstm", "vstx", "bpmn", "xmind"),
            Arrays.asList("pdf", "png", "jpg", "jpeg", "svg", "html")
        );
    ...
    /**
     * 获取指定文件类别支持的所有扩展名（带点号前缀）
     * 
     * @param category 文件类别
     * @return 带点号前缀的扩展名数组
     */
    public String[] getArchiveExtensionsWithDotPrefix(FileCategory category) {
        Set<String> extensions = getSupportedExtensions(category);
        // 添加复合扩展名
        Set<String> allExtensions = new HashSet<>(extensions);
        if (category == FileCategory.ARCHIVE) {
            allExtensions.add("tar.gz");
            allExtensions.add("tgz");
        }
    ...
    /**
     * 获取指定文件类别支持的所有扩展名（不带点号前缀）
     * 
     * @param category 文件类别
     * @return 不带点号前缀的扩展名数组
     */
    public String[] getArchiveExtensionsWithoutDotPrefix(FileCategory category) {
        Set<String> extensions = getSupportedExtensions(category);
        // 添加复合扩展名
        Set<String> allExtensions = new HashSet<>(extensions);
        if (category == FileCategory.ARCHIVE) {
