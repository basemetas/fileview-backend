...
JAR_FILE="/opt/fileview/lib/preview/${APP_NAME}.jar"
CONFIG_DIR="/opt/fileview/config/preview"
LOG_DIR="/opt/fileview/logs/preview"
DATA_DIR="/opt/fileview/data/preview"
PID_DIR="/opt/fileview/bin/preview"
...
# 元空间配置
JAVA_METASPACE_MIN="${JAVA_METASPACE_MIN:-96m}"
JAVA_METASPACE_MAX="${JAVA_METASPACE_MAX:-192m}"

# GC配置
JAVA_GC_TYPE="${JAVA_GC_TYPE:-G1GC}"
JAVA_GC_PAUSE_TIME="${JAVA_GC_PAUSE_TIME:-150}"
