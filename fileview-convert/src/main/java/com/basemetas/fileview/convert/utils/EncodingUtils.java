...
public class EncodingUtils {
     ...
     */
    public static void processRequestEncoding(BaseConvertRequest request) {
        if (request == null) {
            return;
        }
        try {
            ...
            if (request.getFilePath() != null) {
                String decodedPath = decodeIfNeeded(request.getFilePath());
                if (!decodedPath.equals(request.getFilePath())) {
                    request.setFilePath(decodedPath);
